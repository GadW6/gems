...
<form class="max-w-4xl md:px-0 mx-auto my-8 px-3" action="{{ url('cms/contents') }}" method="POST">
  @csrf
  <div class="mb-4">
  ...
  <div class="mb-6">
    ...
    <input class="shadow w-full py-2 px-3 text-gray-700 leading-tight" id="section-title" name="section-title" type="section-title" value="{{ old('section-title') }}">
    @error('section-title')
      <p class="text-red-500 text-xs italic mt-2 ml-1">{{ $message }}</p>
    @enderror
  </div>
