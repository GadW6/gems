...
<form class="container flex flex-wrap max-w-4xl mx-auto py-5 px-3 md:px-0" action="{{ url()->current() . './../' }}" method="POST" novalidate autocomplete="off" onsubmit="copyPaste(event)">
  ...
  <div class="w-full mb-3">
    ...
    <input class="shadow w-full py-2 px-3 text-gray-700 leading-tight" name="title" id="title" type="text" value="{{ old('title', $section->c_title) }}">
    @error('title')
  ...
  <div class="h-full mb-4 text-gray-800 w-full">
    ...
    <div class="bg-white shadow text-gray-700 leading-tight" id="editor" style="min-height: 30vh;">{!! old('article', $section->c_article) !!}</div>
